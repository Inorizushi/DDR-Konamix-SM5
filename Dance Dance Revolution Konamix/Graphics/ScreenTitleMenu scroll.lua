...
t[#t+1] =	LoadActor(THEME:GetPathG("ScreenTitle","ParticlesRight.lua")) .. {
		InitCommand=cmd(zoom,0.275;addx,-(SCREEN_WIDTH/2);addy,-30;fadeleft,0.45);
...
t[#t+1] =	LoadFont("ScreenTitleMenu") .. {
		...
		GainFocusCommand=cmd(stoptweening;linear,0.1;diffuse,Color.Green;strokecolor,Color.Black);
