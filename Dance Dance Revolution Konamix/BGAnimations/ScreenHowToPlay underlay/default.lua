...
local t = Def.ActorFrame{
		...
		Def.Model{
			...
			OnCommand=cmd(hibernate,3;linear,0.317;rotationx,52;zoom,20;y,SCREEN_CENTER_Y+107;sleep,3.017;linear,0.316;rotationx,20.5;y,SCREEN_CENTER_Y+162;sleep,1.05;linear,0.434;rotationy,360;sleep,1.016;diffusealpha,0;sleep,13.917;linear,0.5;diffusealpha,0);
		};
	};
};
return t;